...
function setup() {
  ...
  kangaroo = createSprite(50,200,70,50);
 ...
 button = createImg('assets/restart.png')
 button.position(99900,200);
 button.size(50,50);
 button.mouseClicked(reinicio);
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    if(keyDown("space")&& kangaroo.y>270) {
      jumpSound.play();
      kangaroo.velocity.y = -16;
    }
  
    kangaroo.velocity.y = kangaroo.velocity.y + 0.8
    spawnShrubs();
    spawnObstacles();
